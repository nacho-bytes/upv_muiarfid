...
to go
  ...
  repeat 5 [ ask fishes [ fd 0.2 ] display ]
...
to flee
    set predators-in-view predators in-cone 10 120
    if any? predators-in-view [

      set heading 90 + towards one-of predators-in-view
